...
class DatabaseManager:
    def __init__(self, hostname='Telegram_2002db', database='Telegram_2002', username='postgres', password='12345678', port_id=5432):
    ...
    def save_message_to_db_message(self, message_id, sender_id, name_sender, content_message, tele_message, date):
        conn = None
        try:
            conn = self.get_db_connection()
            with conn.cursor() as cur:
